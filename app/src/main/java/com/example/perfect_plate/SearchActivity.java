...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] placeType = {"restaurant", "hotel", "food"};
        String[] placeName = {"Restaurants", "Hotels", "Food"};
        spinner.setAdapter(new ArrayAdapter<>(SearchActivity.this, android.R.layout.simple_spinner_dropdown_item, placeName));
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json​" + "?location=" + CurrentLat + ","
                            + CurrentLong + "&radius=5000" + "&type=" + placeType[i] + "&sensor=true" + "&key="
